...
class AccelMagView extends Ui.View {
    ...
    function onUpdate(dc) {
        ...
        if (mag != null) {
            dc.drawText(width / 2, height - 70, Gfx.FONT_TINY, "Mx = " + mag[0], Gfx.TEXT_JUSTIFY_CENTER);
            dc.drawText(width / 2, height - 50, Gfx.FONT_TINY, "My = " + mag[1], Gfx.TEXT_JUSTIFY_CENTER);
            dc.drawText(width / 2, height - 30, Gfx.FONT_TINY, "Mz = " + mag[2], Gfx.TEXT_JUSTIFY_CENTER);
        } else {
            dc.drawText(width /2, height - 30, Gfx.FONT_TINY, "no Mag", Gfx.TEXT_JUSTIFY_CENTER);
        }
